dth_admin_jun20 <- fread("~/32HN ITS/32HN-ITS/DTH Data/32HN_ITS_DTH_Admin_from 2020Jun to 2021May.txt",
                         sep=",", header=TRUE,
                         encoding = "UTF-8") %>%
...
dth_admin_jun21 <- fread("~/32HN ITS/32HN-ITS/DTH Data/32HN_ITS_DTH_Admin_discharge from Jun2021.txt",
                         sep=",", header=TRUE,
                         encoding = "UTF-8") %>%
  mutate(ChanDoanRa=stri_trans_general(ChanDoanRa, id = "Latin-ASCII"),
         ChanDoanPhuRa=stri_trans_general(ChanDoanPhuRa, id = "Latin-ASCII"),
